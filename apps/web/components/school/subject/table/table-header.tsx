...
import { SubjectFilter } from '@/components/school/subject/table/subject-filter';
import CreateSubjectDialog from '@/components/school/subject/table/create-subject-dialog';
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6">
      <div className="flex flex-col w-full">
        ...
        <CreateSubjectDialog open={open} onOpenChange={setOpen} />
        <AppAlertDialog

...
export type Student = {
  __typename?: 'Student';
  enrollmentYear?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
...
export type DeleteTeachersMutation = { __typename?: 'Mutation', deleteTeachers: { __typename?: 'ApiResponse', ok?: boolean | null, message?: string | null } };

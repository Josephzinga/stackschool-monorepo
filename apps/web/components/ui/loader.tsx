...
export const Loader = () => (
  <div className="h-full animate-pulse bg-linear-to-b dark:from-gray-900 dark:to-gray-950 from-slate-100 to-slate-200 w-full flex items-center justify-center">
    <LoaderOne />
  </div>
);

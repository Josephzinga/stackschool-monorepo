...
import {
  ClassStudentTable,
  columns,
} from '@/components/lists/class/student-table/columns';
import { DataTable } from '@/components/lists/class/student-table/data-table';
import { useGetClassStudentsQuery } from '@stackschool/ui';
import { useDeferredValue, useMemo } from 'react';
import { ClassStudentTableHeader } from '@/components/lists/class/student-table/table-header';

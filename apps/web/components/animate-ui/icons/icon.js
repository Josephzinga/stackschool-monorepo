...
exports.staticAnimations = exports.pathClassName = void 0;
exports.AnimateIcon = AnimateIcon;
exports.IconWrapper = IconWrapper;
exports.useAnimateIconContext = useAnimateIconContext;
...
exports.staticAnimations = staticAnimations;
...
function AnimateIcon({ asChild = false, animate = false, animateOnHover = false, animateOnTap = false, animateOnView = false, animateOnViewMargin = '0px', animateOnViewOnce = true, animation = 'default', loop = false, loopDelay = 0, initialOnAnimateEnd = false, completeOnStop = false, persistOnAnimateEnd = false, delay = 0, children, ...props }) {
    const controls = (0, react_1.useAnimation)();
    ...
    const { ref: inViewRef, isInView } = (0, use_is_in_view_1.useIsInView)(viewOuterRef, {
    ...
    const content = asChild ? (<slot_1.Slot ref={inViewRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onPointerDown={handlePointerDown} onPointerUp={handlePointerUp} {...props}>
      {children}
    </slot_1.Slot>) : (<react_1.motion.span ref={inViewRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onPointerDown={handlePointerDown} onPointerUp={handlePointerUp} {...props}>
      {children}
    </react_1.motion.span>);
    return (<AnimateIconContext.Provider value={{
            controls,
...
exports.pathClassName = pathClassName;
function IconWrapper({ size = 28, animation: animationProp, animate, animateOnHover, animateOnTap, animateOnView, animateOnViewMargin, animateOnViewOnce, icon: IconComponent, loop, loopDelay, persistOnAnimateEnd, initialOnAnimateEnd, delay, completeOnStop, className, ...props }) {
    ...
    if (context) {
        ...
        const hasOverrides = animate !== undefined ||
        ...
        <IconComponent size={size} className={(0, utils_1.cn)(className, (animationToUse === 'path' || animationToUse === 'path-loop') &&
                pathClassName)} {...props}/>
      </AnimateIconContext.Provider>);
    }
    if (animate !== undefined ||
        ...
        return (<AnimateIcon animate={animate} animateOnHover={animateOnHover} animateOnTap={animateOnTap} animateOnView={animateOnView} animateOnViewMargin={animateOnViewMargin} animateOnViewOnce={animateOnViewOnce} animation={animationProp} loop={loop} loopDelay={loopDelay} delay={delay} completeOnStop={completeOnStop} asChild>
        <IconComponent size={size} className={(0, utils_1.cn)(className, (animationProp === 'path' || animationProp === 'path-loop') &&
                pathClassName)} {...props}/>
      </AnimateIcon>);
    }
    return (<IconComponent size={size} className={(0, utils_1.cn)(className, (animationProp === 'path' || animationProp === 'path-loop') &&
            pathClassName)} {...props}/>);
}
function getVariants(animations) {
    ...
    if (animationType in staticAnimations) {
        ...
        for (const key in animations.default) {
            if ((animationType === 'path' || animationType === 'path-loop') &&
                key.includes('group'))
                continue;
            result[key] = variant;
        }

...
import {type CreateClassSubjectFormData, createClassSubjectSchema,} from '@stackschool/contracts';
    ...
    onMutate: async (variables) => {
      ...
      const optimistic = {
        ...
        teacher: {
          ...
          user: {
            profile: {
              firstName: selectedTeacher?.schoolProfile?.firstName,
              lastName: selectedTeacher?.schoolProfile?.lastName,
            },
          },
        },
      };

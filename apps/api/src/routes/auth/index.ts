...
import googlePostRoute from './google-post.route';
import facebookPostRoute from './facebook-post.route';
...
router.use('/auth', googlePostRoute);
router.use('/auth', facebookPostRoute);

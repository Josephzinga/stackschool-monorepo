...
export function AuthImageSlider({ slides, interval = 6000 , className}: AuthImageSliderProps) {
    ...
    return (
        <div className={cn("relative  z-50 overflow-hidden w-full h-full", className)}>
